...
def get_news():
    ...
    response = ses.get(
        f'https://www.nytimes.com/international/section/world/europe',
    ...
    list_titles = [
        i.find('h2', class_='css-1kv6qi e15t083i0').text for i in news
    ]
    list_short_news_description = []
    list_links = [
        'https://www.nytimes.com/' + i.find('a').get('href') for i in news
    ]
